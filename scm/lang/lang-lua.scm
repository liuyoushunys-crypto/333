...
(define-syntax if (syntax-rules (then elseif else end) ((_ cond then body ... end) (if cond (begin body ...) #f)) ((_ cond then body ... elseif clauses ... end) (if cond (begin body ...) (if ,@(cdr clauses) ...))) ((_ cond then body ... else body2 ... end) (if cond (begin body ...) (begin body2 ...)))))
