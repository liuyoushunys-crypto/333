;; test-unicode.scm — Unicode: UTF-8, multilingual strings, CJK, emoji
;; Generated from merged test suites

;; Unicode and multilingual string tests


(display "\n=== test_multilingual.scm ===\n")
;; ==========================================
;; 字符串扩展操作 多语种支持测试
;; ==========================================
...
(display "\n=== test-standards.scm ===\n")
;; test-standards.scm — merged test file
