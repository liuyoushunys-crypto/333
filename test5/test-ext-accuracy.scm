...
(check "generator-filter" (procedure? generator-filter) #t)
  (check "generator-filter" (not (not (procedure? generator-filter))) #t)

(check "generator-take" (procedure? generator-take) #t)
...
(check "unzip3" (unzip3 '((1 a x) (2 b y))) '((1 2) (a b) (x y)))
(check "unzip4" (unzip4 '((1 a x p) (2 b y q))) '((1 2) (a b) (x y) (p q)))
(check "unzip5" (unzip5 '((1 a x p m) (2 b y q n))) '((1 2) (a b) (x y) (p q) (m n)))
(check "read-line" (eof-object? (read-line)) #t)
(check "read-string" (string? (read-string 10 (open-input-string "abc"))) #t)
