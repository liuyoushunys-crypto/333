...
(define (my-definemacro name-pat . body) ((lambda (name pat) (sx-defmacro name (quote args) (list (list (quote sx-macro-expand) (list (quote quote) pat) (list (quote quote) body) (quote args) (quote (sx-expand-env))))) name) (car name-pat) (cdr name-pat)))
